...
<xsl:stylesheet xpath-default-namespace="http://www.tei-c.org/ns/1.0"
	...
	<xsl:param name="evtTxt">
		...
		<ul>
			<li><a href="http://pelavicino.labcd.unipi.it/evt/" target="blank">Codice Pelavicino Digitale <i class="fa fa-external-link"></i></a></li>
			<li><a href="http://vbd.humnet.unipi.it/beta2/" target="blank">Vercelli Book Digitale <i class="fa fa-external-link"></i></a></li>
		</ul>
		<p>EVT has a home page in the <a href="https://sourceforge.net/p/evt-project/" target="blank">SourceForge <i class="fa fa-external-link"></i></a> repository,
