...
<xsl:stylesheet xpath-default-namespace="http://www.tei-c.org/ns/1.0"
    ...
    <xsl:template match="//tei:table" mode="interp dipl pro #default">
        <div class="table">
            <xsl:apply-templates mode="#current"/>
        </div>
    </xsl:template>
    
    <xsl:template match="//tei:table/tei:head" mode="interp dipl pro #default">
        <div class="table-head">
            <xsl:apply-templates mode="#current"/>
        </div>
    </xsl:template>
    
    <xsl:template match="//tei:table/tei:row" mode="interp dipl pro #default">
        <div class="table-row">
            <xsl:apply-templates mode="#current"/>
        </div>
    </xsl:template>
    
    <xsl:template match="//tei:table/tei:row/tei:cell" mode="interp dipl pro #default">
    ...
    <!-- NOTE Note or annotation -->
    <xsl:template match="//tei:note" mode="interp dipl pro #default">
        <xsl:choose>
